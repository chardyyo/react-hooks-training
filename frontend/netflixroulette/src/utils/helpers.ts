import { GenreFilters, GenreQueries, SortFilters, SortQueries } from "../types";
...
export const hasGenre = (
  genre: GenreQueries | string | null
): genre is GenreQueries => !!genre && genre in GenreFilters;

export const hasSortBy = (
  sortBy: SortQueries | string | null
): sortBy is SortQueries => !!sortBy && sortBy in SortFilters;
